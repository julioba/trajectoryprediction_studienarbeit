...
def main():
    ...
    parser.add_argument('--pred_length', type=int, default=22,
...
def train(args):
    ...
    for epoch in range(args.num_epochs):
        ...
        for batch in range(dataloader.num_batches):
            ...
            # if a new dataset is set, zero the counter of batch
            ...
            for sequence in range(dataloader.batch_size):
                ...
                # number of pedsestrians in this sequence per frame
        ...
        if dataloader.additional_validation and (epoch) in validation_epoch_list:
            ...
            for batch in range(dataloader.num_batches):
                ...
                for sequence in range(dataloader.batch_size):
                    ...
                    target_id_values = orig_x_seq[0][lookup_seq[target_id], 0:2]#orig_x_seq[0][lookup_seq[target_id], 0:2]
